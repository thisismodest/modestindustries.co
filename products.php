...
$intro_title = "Products";
$intro_description = " Making things to make you smile.";

$intro_img_url = "header-camera.png";
$intro_img_alt = "Products by Modest Industries";
...
include 'header.php'; ?>
  ...
  <div class="section text">
    ...
    <p class="col1"> Bacon ipsum dolor amet spare ribs sirloin pancetta short ribs. Capicola boudin pork porky chop meatball filet mignon landjaeger meatloaf turkey beef ribs ball tip kielbasa cow ground round doner. Shankle tenderloin pork belly salami hamburger boudin.</p>
  </div>

  <div class="section product">
    <div class="product-box col2">
      <img src="img/placeholder-phone.jpg" class="product-image">
      <h2>Sweat Roulette #1</h2>
      ...
      <a href="#" class="main-button">Play Sweat Roulette</a>
    </div>

    <div class="product-box col2">
      <img src="img/placeholder-phone.jpg" class="product-image">
      <h2>Sweat Roulette #2</h2>
      <p>Bacon ipsum dolor amet pork belly spare ribs sirloin pancetta short ribs. Capicola boudin pork chop meatball filet mignon landjaeger meatloaf turkey beef ribs ball tip kielbasa cow ground round doner. Shankle tenderloin pork belly meatloaf saeatball filet mignon landjaeger meatloaf turkey beef ribs ball tip kielbasa cow ground round doner.</p>
